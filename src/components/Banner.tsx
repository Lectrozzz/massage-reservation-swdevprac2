...
export default function Banner () {
    ...
    return (
        <div className='block w-screen h-[80vh] relative m-0 p-[5px]' onClick={()=>{setIndex(index+1)}}>
            ...
            {
                session? <div className='z-30 absolute top-5 right-10 font-semibold text-white text-xl' style={{textShadow: "1px 1px 1px black"}}>Welcome {session.user.name}</div> : null
            }
